...
(function() {
  window.PDJSobj = (function() {
    ...
    PDJSobj.prototype.sendRequest = function(params) {
      var accepts, contentType, data, error, headers, query, success, type, url, xhr;
      if (params == null) {
        params = {};
      }
      accepts = params.accepts, contentType = params.contentType, data = params.data, error = params.error, headers = params.headers, success = params.success, type = params.type, url = params.url;
